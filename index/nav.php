<nav class="navbar navbar-expand-lg fixed-top">
        ...
        <div class="collapse navbar-collapse menu" id="navbarTogglerDemo03" style="background-color:white;">
            <ul class="nav navbar-nav navbar-list mx-auto">
                <li class="nav-item ml-4"><a class="nav-link button" id="index"  href="accueil">Accueil <span class="bottom-solid"></span></a></li>
            ...
            <ul class="nav navbar-nav pull-sm-right">
                <li class="nav-item nav-seconnecter ml-4 " data-tooltip="Se connecter"><a class="nav-link button nav-connection" href="#lien"><i class="mr-2 nav-connection ml-2 fa fa-user"></i> Se connecter</a></li>
            </ul>
        </div>
    </nav>