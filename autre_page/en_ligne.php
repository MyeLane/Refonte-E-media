            ...
            <div class="col-12 col-sm-12 col-md-5 col-lg-5">
                ...
                <div class="modal fade" id="myModal1">
                    ...
                    <div class="modal-content">
                        ...
                        <h4 class="modal-title color-ltic">Informatique et système embarqués</h4>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        </div>
                        
                        <!-- Modal body -->
                        <div class="modal-body">
                        <h4 class="color-ltic">Objectifs</h4>
                        ...
                        <h4 class="color-ltic">Contenu de la formation</h4>
                        ...
                        <h4 class="color-ltic">Parcours :</h4>
                        <ul>
                            <li>Réseau et Système</li>
                            <li>Télécommunication</li>
                            <li>Génie Logiciel</li>
                        </ul>
                        <h4 class="ml-2 color-ltic">Admissibilité :</h4>
                        ...
                        <h4 class="ml-2 color-ltic">Sanction</h4>
                        ...
                        <h4 class="ml-2 color-ltic">Débouchés</h4>
...
<!-- Button to Open the Modal -->
                ...
                <div class="modal fade" id="myModal2">
                    ...
                    <div class="modal-content">
                        ...
                        <!-- Modal Header -->
                        <div class="modal-header">
                        <h4 class="modal-title color-lcan">COMMUNICATION AUDIOVISUELLE ET NUMERIQUE (CAN) - LICENCE</h4>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        </div>
                        
                        <!-- Modal body -->
                        <div class="modal-body">
                            <h4 class="ml-2 color-lcan">Objectifs</h4>
                            ...
                            <h4 class="ml-2 color-lcan">Contenu de la formation</h4>
                            ...
                            <h4 class="ml-2 color-lcan">Parcours :</h4>
                            <ul>
                                <li>Image</li>
                                <li>Développement web</li>
                            </ul>
                            <h4 class="ml-2 color-lcan">Admissibilité :</h4>
                            <p class="text-justify container-fluid">La formation est ouverte à toutes personnes ayant un baccalauréat, de toutes les séries : A/C/D/Technique.</p>
                            <h4 class="ml-2 color-lcan">Sanction</h4>
                            <p class="text-justify container-fluid">La formation permet aux étudiants d’acquérir les diplômes de Licence en COMMUNICATION AUDIOVISUELLE ET NUMERIQUE, et ce suivant le système LMD actuellement appliqué à Madagascar.</p>
                            <h4 class="ml-2 color-lcan">Débouchés</h4>
                            <p class="text-justify container-fluid">La formation permet d’occuper des postes de responsable de développement de projets, journaliste, rédacteur, responsable des coproductions dans des entreprises telles que les sociétés de production, les sociétés de distribution, les chaînes de télévision, sites Internet, Industrie cinématographique, etc.</p>
                        </div>
...
<!-- Button to Open the Modal -->
                ...
                <div class="modal fade" id="myModal3">
                    ...
                    <div class="modal-content">
                        ...
                        <!-- Modal Header -->
                        <div class="modal-header">
                        <h4 class="modal-title color-lmpj">MARKETING, PUBLICITE ET JOURNALISME (MPJ) - LICENCE</h4>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        </div>
                        
                        <!-- Modal body -->
                        <div class="modal-body">
                        <h4 class="ml-2 color-lmpj">Objectifs</h4>
                        ...
                        <h4 class="ml-2 color-lmpj">Contenu de la formation</h4>
                        ...
                        <h4 class="ml-2 color-lmpj">Parcours :</h4>
                        <ul>
                            <li>Marketing Publicité</li>
                            <li>Journalisme</li>
                        </ul>
                        <h4 class="ml-2 color-lmpj">Admissibilité :</h4>
                        ...
                        <h4 class="ml-2 color-lmpj">Sanction</h4>
                        ...
                        <h4 class="ml-2 color-lmpj">Débouchés</h4>
            ...
            <div class="col-12 col-sm-12 ml-3 col-md-5 col-lg-5">
                ...
                <div class="modal fade" id="myModal">
                    ...
                    <div class="modal-content">
                        ...
                        <!-- Modal Header -->
                        <div class="modal-header">
                        <h4 class="modal-title color-lmba">MANAGEMENT - LICENCE</h4>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        </div>
                        
                        <!-- Modal body -->
                        <div class="modal-body">
                            <h4 class="color-lmba">Objectifs</h4>
                            ...
                            <h4 class="color-lmba">Contenu de la formation</h4>
                            ...
                            <h4 class="color-lmba">Parcours : </h4>
                            <ul>
                                <li>Finance et Comptabilité</li>
                                <li>Administration des affaires</li>
                                <li>Commerce international</li>
                            </ul>
                            <h4 class="color-lmba">Admissibilité : </h4>
                            ...
                            <h4 class="color-lmba">Sanction</h4>
                            ...
                            <h4 class="color-lmba">Débouché</h4>
            ...
            <div class="col-12 col-sm-12 col-md-5 col-lg-5">
                ...
                <div class="modal fade" id="myModal4">
                    ...
                    <div class="modal-content">
                        ...
                        <!-- Modal Header -->
                        <div class="modal-header">
                        <h4 class="modal-title color-ldrt">DROIT - LICENCE</h4>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        </div>
                        
                        <!-- Modal body -->
                        <div class="modal-body">
                            <h4 class="color-ldrt">Objectifs</h4>
                            ...
                            <h4 class="color-ldrt">Contenu de la formation</h4>
                            ...
                            <h4 class="color-ldrt">Parcours</h4>
                            <ul>
                                <li>Droit public</li>
                                <li>Droit Privé et des affaires</li>
                                <li>Droit international et Diplomatie</li>
                            </ul>
                            <h4 class="color-ldrt">Admissibilité : </h4>
                            <p class="text-justify">La formation est ouverte à toutes personnes ayant un baccalauréat, de toutes les séries : A/C/D/Technique</p>
                            <h4 class="color-ldrt">Débouchés</h4>
            ...
            <!-- Button to Open the Modal -->
                ...
                <div class="modal fade" id="myModal5">
                    ...
                    <div class="modal-content">
                        ...
                        <!-- Modal Header -->
                        <div class="modal-header">
                        <h4 class="modal-title color-mtic">INFORMATIQUE ET SYSTÈME EMBARQUÉS</h4>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        </div>
                        
                        <!-- Modal body -->
                        <div class="modal-body">
                            <h4 class="color-mtic">Objectifs</h4>
                            <p class="text-justify">La mention Informatique et télécommunication a pour objectif de former des spécialistes dans le domaine du génie informatique et des télécommunications. Les diplômés sont capables de mettre à profit leurs connaissances dans les applications des interconnexions de réseaux, des systèmes de télécommunications et de la sécurisation des échanges. Ils possèdent les compétences pour concevoir, intégrer, exploiter et administrer les systèmes informatiques nécessaires au fonctionnement d'une entreprise mais aussi de mieux adapter les fonctionnalités des réseaux locaux émergeants.</p>
                            <h4 class="color-mtic">Contenu de la formation</h4>
                            <p class="text-justify">La formation en nouvelle technologie de l’Informatique et de la Communication compte parmi les matières qu’elle dispense les matières suivantes : Algorithme, Base de la télécommunication analogique, Algèbre, Cryptographie, Circuit séquentiel, Transformation intégrale, Système embarqué, Management, Probabilité Statistique</p>
                            <h4 class="color-mtic">Parcours : </h4>
                            <ul>
                                <li>Management des Systèmes d'informations</li>
                                <li>Electronique Embarqué</li>
                                <li>Cybersécurité et Système</li>
                            </ul>
                            <h4 class="color-mtic">Admissibilité : </h4>
                            ...
                            <h4 class="color-mtic">Sanction: </h4>
                            ...
                            <h4 class="color-mtic">Débouchés:</h4>
            ...
            <div class="col-12 col-sm-12 ml-3 col-md-5 col-lg-5">
                ...
                <div class="modal fade" id="myModal6">
                    ...
                    <div class="modal-content">
                        ...
                        <!-- Modal Header -->
                        <div class="modal-header">
                        <h4 class="modal-title color-mcan">Modal Heading</h4>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        </div>
...
<!-- Button to Open the Modal -->
                ...
                <div class="modal fade" id="myModal7">
                    ...
                    <div class="modal-content">
                        ...
                        <!-- Modal Header -->
                        <div class="modal-header">
                        <h4 class="modal-title color-mmpj">MARKETING, PUBLICITE ET JOURNALISME (MPJ) - MASTER</h4>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        </div>
                        
                        <!-- Modal body -->
                        <div class="modal-body">
                            <h4 class="color-mmpj">Objectifs</h4>
                            ...
                            <h4 class="color-mmpj">Contenu de la formation</h4>
                            ...
                            <h4 class="color-mmpj">Parcours</h4>
                            <ul>
                                <li>Marketing Publicité</li>
                                <li>Journalisme</li>
                            </ul>
                            <h4 class="color-mmpj">Admissibilité :</h4>
                            ...
                            <h4 class="color-mmpj">Sanction :</h4>
                            ...
                            <h4 class="color-mmpj">Débouchés :</h4>
...
<!-- Button to Open the Modal -->
                ...
                <div class="modal fade" id="myModal8">
                    ...
                    <div class="modal-content">
                        ...
                        <!-- Modal Header -->
                        <div class="modal-header">
                        <h4 class="modal-title color-mmba">MBA</h4>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        </div>
                        
                        <!-- Modal body -->
                        <div class="modal-body">
                            <h4 class="color-mmba">Objectifs : </h4>
...
<!-- Button to Open the Modal -->
                ...
                <div class="modal fade" id="myModal9">
                    ...
                    <div class="modal-content">
                        ...
                        <!-- Modal Header -->
                        <div class="modal-header">
                        <h4 class="modal-title color-mdrt">DROIT - MASTER</h4>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        </div>
                        
                        <!-- Modal body -->
                        <div class="modal-body">
                            <h4 class="color-mdrt">Objectifs</h4>
                            ...
                            <h4 class="color-mdrt">Contenu de la formation</h4>
                            ...
                            <h4 class="color-mdrt">Parcours</h4>
                            <ul>
                                <li>Droit public</li>
                                <li>Droit Privé et des affaires</li>
                                <li>Droit international et Diplomatie</li>
                            </ul>
                            <h4 class="color-mdrt">Admissibilité</h4>
                            <p>Licence en droit</p>
                            <h4 class="color-mdrt">Sanction</h4>
                            ...
                            <h4 class="color-mdrt">Débouchés</h4>
                            <p class="text-justify">Les étudiants seront aptes à exercer dans toutes les organisations Les étudiants sortant de l’université en ligne peuvent aspirer à devenir : juriste d’entreprise, notaire, avocat, magistrat, greffier, huissier, officier de police judiciaire, assistant juridique de cabinet d’avocat, etc.</p>
                        </div>
